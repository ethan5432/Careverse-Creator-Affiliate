  ...
  return (
    ...
    <div className="hero-copy reveal">
            ...
            <div className="hero-bottom">
              <p className="lede">Careverse helps you see cost and coverage, book the visit and the follow-up, and keep your providers in one thread so you never start from scratch.</p>
